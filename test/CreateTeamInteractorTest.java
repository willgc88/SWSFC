...
public class CreateTeamInteractorTest {
    ...
    private TestTeamFactory testTeamFactory;
    ...
    public void setUp() {
        ...
        testTeamFactory = new TestTeamFactory();  // Use a different variable name
    ...
    public void testExecute_Success() {
        ...
        assertNotNull(testTeamFactory.createdTeam);
        assertEquals("newTeam", testTeamFactory.createdTeam.getTeamName());
    ...
    public void testCreateTeamInteractor() {
        ...
        assertNotNull(testTeamFactory.createdTeam);
        assertEquals("testTeam", testTeamFactory.createdTeam.getTeamName());
