...
public class CreateUserInteractorTest {
    ...
    // - Tests cover practically all the use case interactor code. (>90% line coverage) User, Team, Startup?, Draft
    // - Tests cover a significant amount of the overall code base (>70% line coverage) 7% line coverage
    // - Evidence of code coverage and documentation of what wasn't tested (and why) is present and of high quality.C
